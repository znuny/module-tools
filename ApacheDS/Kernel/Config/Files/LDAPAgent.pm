...

{
    ...
    $Self->{'AuthSyncModule::LDAP::UserSyncGroupsDefinition1'} = {
        'cn=Sith Lords,ou=orders,ou=groups,o=force' => {    # LDAP  group.
            ...
            # 'sithlords' => {      # This group does not exist in Znuny you need to create it in order to use it.
            #     rw => 1,
            #     ro => 1,
            # },
        },
    ...
    $Self->{'AuthSyncModule::LDAP::UserSyncRolesDefinition1'} = {
        'cn=Sith Lords,ou=orders,ou=groups,o=force' => {    # LDAP  group.
            'sithlordsrole' => 1,    # Znuny role. (This role does not exists in Znuny, add it to get the results)
            'ldaprole'      => 0,    # Znuny role. (This role does not exists in Znuny, add it to get the results)
        },
        'cn=Night Sisters,ou=orders,ou=groups,o=force' => {
